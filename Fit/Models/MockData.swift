...
class MockDataProvider {
    ...
    let sampleWorkoutPlans: [WorkoutPlan] = [
        WorkoutPlan(
            ...
            duration: 30,
            exercises: [
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[0], targetReps: 10, targetWeight: 0),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[1], targetReps: 15, targetWeight: 0),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[0], targetReps: 8, targetWeight: 0),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[1], targetReps: 12, targetWeight: 0),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[3], targetReps: 30, targetWeight: 0, restTime: 0)
            ],
        ...
        WorkoutPlan(
            ...
            duration: 45,
            exercises: [
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[2], targetReps: 12, targetWeight: 20),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[2], targetReps: 10, targetWeight: 22.5),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[2], targetReps: 8, targetWeight: 25),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[0], targetReps: 15, targetWeight: 0),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[0], targetReps: 12, targetWeight: 0),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[0], targetReps: 10, targetWeight: 0)
            ],
        ...
        WorkoutPlan(
            ...
            duration: 20,
            exercises: [
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[4], targetReps: 30, targetWeight: 0, restTime: 10),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[0], targetReps: 20, targetWeight: 0, restTime: 10),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[1], targetReps: 25, targetWeight: 0, restTime: 10),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[4], targetReps: 30, targetWeight: 0, restTime: 10),
                ExerciseSet(exercise: MockDataProvider.shared.sampleExercises[0], targetReps: 15, targetWeight: 0, restTime: 10)
            ],
